      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Full stack developer and junior project manager
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Yann, a full stack web developer and junior project manager
            based in Brussels. I develop experiences users love with a great
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/yann-lauwers"
