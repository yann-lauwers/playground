...
Lately I had to create this kind of responsive background color change in the middle of a div. I struggled a lot to find a solution that would work on all browsers.
...
One of the first thing I did was to go on Caniuse to check the compatibility of Linear gradient with the browsers. It's a CSS property I do not often use so I prefer to make sure everyone will see what I see.
